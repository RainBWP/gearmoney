...
class BudgetCardSmall extends StatelessWidget {
	...
	Widget build(BuildContext context) {
		...
		final cats = categoryColors ?? [AppColors.primary(context), Colors.grey, Colors.grey[400]!];
				...
				children: [
					Expanded(
						child: Column(
							...
							children: [
								Text('$name - \$$amount', style: TextStyle(fontSize: 14, color: AppColors.textPrimary(context), fontWeight: FontWeight.w600)),
								SizedBox(height: 8),
								Row(
									children: List.generate(
										...
										(i) => Container(
											...
											width: 18,
											height: 18,
											decoration: BoxDecoration(color: cats[i], shape: BoxShape.circle),
										),
									),
								),
							],
					...
					Column(
						...
						children: [
							Text(label, style: TextStyle(color: statusColor, fontWeight: FontWeight.w600)),
						],
					),
				],
			),
